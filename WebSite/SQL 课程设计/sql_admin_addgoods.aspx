<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sql_admin_addgoods.aspx.cs"
                   ...
                   <center>
                       <table  cellspacing="20">
                            <tr>
                                ...
                                <td align="left"><input type="text" id="goods_id" runat="server" /></td>
                            </tr>

                             <tr>
                                <td align="right">商品名</td>
                                <td align="left"><input type="text" id="goods_name" runat="server" /></td>
                            </tr>

                             <tr>
                                <td align="right">商品价格</td>
                                <td align="left"><input type="text" id="goods_price" runat="server" /></td>
                            </tr>
                            <tr>
                                <td align="right">商品数量</td>
                                <td align="left"><input type="text" id="goods_num" runat="server" /></td>
                            </tr>
                             <tr>
                                 <td align="center" colspan="2">
                                    <asp:Button ID="button1" class="button" runat="server" OnClick="Button1_Click" Text="增加" />
                                 </td>
                            </tr>

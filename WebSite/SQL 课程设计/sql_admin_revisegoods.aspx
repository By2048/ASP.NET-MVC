<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sql_admin_revisegoods.aspx.cs"
                   ...
                   <center>
                       <table  cellspacing="20">
                            <tr>
                             ...
                             <tr>
                                <td align="right">商品新名称</td>
                                <td align="left"><input type="text" id="goods_new_name" runat="server" /></td>
                            </tr>

                             <tr>
                                <td align="right">商品新价格</td>
                                <td align="left"><input type="text" id="goods_new_price" runat="server" /></td>
                            </tr>
                            <tr>

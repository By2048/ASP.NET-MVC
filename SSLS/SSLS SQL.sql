...
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('4','11_1806098','三国第一人','惨绿少年','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('4','11_1510954','乱明风云','为花做和尚','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('4','11_1401853','重生剑侠图','四条不糊','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('5','11_1806098','三国第一人','惨绿少年','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('5','11_1510954','乱明风云','为花做和尚','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('5','11_1401853','重生剑侠图','四条不糊','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('5','11_1806098','三国第一人','惨绿少年','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
Insert into Book(CategoryID,Code,Name,Authors,Press,ImageUrl,Description,PublishDate,Price,Status,Num)
Values('5','11_1510954','乱明风云','为花做和尚','17K小说网',NULL,NULL,NULL,NULL,'在库',5)
